...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">GIS Map Representation</h2>
    </div>
</div>
...
var barangayIcon = L.icon({
    iconUrl: 'https://cdn.pixabay.com/photo/2020/01/15/09/06/map-4767369_960_720.png',
    ...
    popupAnchor:  [-3, -76] // point from which the popup should open relative to the iconAnchor
            ...
            <?php $countAccident = 0; $countCrime = 0; ?>

            <?php 
            
                foreach($reportCount as $rc) {
                    if($rc->type == "Accident") {
                        if($rc->location == $brgy->id) {
                            $countAccident += 1;
                        }
                    }
            ...
            var information = '<center><a href="barangay-profile/<?php echo $brgy->id ?>"><h6><?php echo $brgy->brgy ?></h6><div>Accidents - <span class="fs-6 fw-bolder"><?php echo $countAccident ?><span></div><div>Crimes - <span class="fs-6 fw-bolder"><?php echo $countCrime ?></span></div></a></center>';
