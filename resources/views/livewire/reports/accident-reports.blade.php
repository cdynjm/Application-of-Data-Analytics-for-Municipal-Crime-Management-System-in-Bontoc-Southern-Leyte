<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        <h4 class="h4">Accident Reports</h4>
    </div>
...
<div class="table-settings mb-4">
    <div class="row justify-content-between align-items-center">
        <div class="col-9 col-lg-8 d-md-flex">
            @if(Auth::user()->type == 1)
                <input type="hidden" id="type" value="Accident">
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                            @if(Auth::user()->type == 2)
                                @if($rep->status == 1)
                                    <a class="dropdown-item text-success d-flex align-items-center" href="#" id="accident-report-respond">
                            ...
                            @if(Auth::user()->type == 2)
                                @if($rep->status == 1)
                                <a class="dropdown-item d-flex align-items-center" href="#" id="accident-report-police">
...
<div class="card card-body shadow border-0 table-wrapper table-responsive">
  ...
  <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
    ...
    @include('livewire.table.accident-report-table')
</div>