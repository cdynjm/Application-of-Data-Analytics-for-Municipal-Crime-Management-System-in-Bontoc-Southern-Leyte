<table class="table table-centered table-nowrap mb-0  @if(Auth::user()->type == 2) mt-4 @endif rounded" id="search-user-result">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="fw-normal">@if($user->type == 3) {{ 'User' }} @endif</span></td>
            ...
            <td>
                @if($user->status == 1)<span class="fw-normal text-danger">{{ 'Pending' }}</span>@endif
                @if($user->status == 0)<span class="fw-normal text-success">{{ 'Verified' }}</span>@endif
            </td>
            <td>
                <div class="btn-group">
